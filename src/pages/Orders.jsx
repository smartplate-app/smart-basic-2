                          ...
                          <div className="flex items-center justify-center gap-1.5 pointer-events-auto">
                            {!isViewer && order.supplier_phone && (
                              <button
                                ...
                                className="text-white text-xs font-medium rounded px-2 py-1 flex items-center justify-center transition-colors"
                                style={{
                                ...
                                {language === 'he' ? 'וואטס' : 'WA'}
                                                      ...
                                                      {!isViewer && order.status === 'sent' && (
                                                        <Button
                                                          ...
                                                          className="px-2 py-1 text-xs bg-green-600 hover:bg-green-700 text-white h-auto"
                                                        >
                                                          {safeT('receive_scan', 'קבלה/סריקה', 'Receive')}
                                                        </Button>
                                                      )}
                                                      {!isViewer && (
                              <>
                                <Button
                                  ...
                                  className="border-gray-300 text-gray-700 hover:bg-gray-100 px-2 py-1 text-xs h-auto"
                                >
                                ...
                                <Button
                                  ...
                                  className="border-red-300 text-red-600 hover:bg-red-50 px-2 py-1 text-xs h-auto"
                                >
