            ...
            {rows.length === 0 ? (
              ...
              <div key={idx} className="p-3 grid grid-cols-1 md:grid-cols-12 gap-2 items-center">
                ...
                <div className="md:col-span-2">
                  ...
                  <Input type="number" step="0.01" value={Number(r.price_per_unit || 0).toFixed(2)} readOnly className="bg-gray-100 cursor-not-allowed" placeholder={language === 'he' ? 'מחיר' : 'Price'} />
                </div>
