          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="md:col-span-2">
              <p className="text-gray-700 text-sm leading-relaxed">
                מטרה: השקה לשוק הישראלי עם סדרת 6 רילז שמחנכת וממירה בעלי מסעדות. טון: ברור, תפעולי, ללא סרבול. ויזואליה: גרדיאנט מודגש (ירוק→טורקיז), טקסט כהה, לוגו.
              </p>
              <div className="flex flex-wrap gap-2 mt-3">
                <Badge className="bg-emerald-600">מודעות</Badge>
                <Badge className="bg-teal-600">חינוך</Badge>
