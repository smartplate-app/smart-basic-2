...
const defaultHashtags = [
  "#SmartPlate", "#SmartPlateBasic", "#מסעדה", "#מסעדנים", "#עלותמזון",
...
const reelsPlan = [
  {
    ...
    script:
      "פותחים במטבח שוקק. מעבר לדשבורד של SmartPlate Basic עם אחוז עלות מזון. קריינות: 'מפסיקים לנחש. סורקים קבלות, רואים עלות מזון אמיתית – היום.' סיום ברקע גרדיאנט ולוגו.",
    cta: "נסו את SmartPlate Basic – תחילה בחינם.",
    caption:
      "עלות מזון לא אמורה להיות תעלומה. סריקה, מעקב ופעולה – בדקות. SmartPlate Basic נשאר פשוט כדי שאתם תישארו חדים.",
  },
  {
    ...
    caption:
      "מהסידור השבועי לשקיפות חודשית – SmartPlate Basic הופך את עלות העבודה לצפויה.",
  },
  {
    ...
    caption:
      "שימוש לאורך זמן מספר את הסיפור. SmartPlate Basic מדבר תוצאות.",
  },
  {
    title: "מקבלה – לתובנה",
    ...
    caption:
      "נייר נכנס, תובנה יוצאת. זה SmartPlate Basic.",
  },
  {
    title: "כלל ה‑60%",
    ...
    caption:
      "כלל פשוט. אפקט גדול. שומרים על עלות משולבת עד 60% עם SmartPlate Basic.",
  },
  {
    title: "למה 'Basic' מנצח",
    hook: "כלים מסובכים מאטים מסעדות.",
    overlays: ["מהיר", "ממוקד", "קודם כל תפעול"],
    shots: ["אנימציות Tap Done", "ממשק נקי", "לוגו"],
    script:
      "מראים זרימות קצרות. 'SmartPlate Basic נועד למטרה: הדברים הקריטיים של כל יום.'",
    cta: "חוזרים לבייסיק – שם מבצעים מנצחים.",
    caption:
      "רזה מנצח מסובך. תמיד. #SmartPlateBasic",
  }
];
