...
function ReportsSidebarInner({ onClose }) {
...
export default function ReportsSidebar({ open, onClose }) {
  if (!open) return null; // No hooks called when closed; hooks inside Inner are consistent
  return (
    <div className="fixed inset-0 z-50">
      <div className="absolute inset-0 bg-black/40" onClick={onClose} />
      <ReportsSidebarInner onClose={onClose} />
    </div>
  );
}