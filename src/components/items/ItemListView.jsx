        ...
        <div className="max-h-[70vh] overflow-y-auto">
          ...
          <TableHeader className="sticky top-[64px] z-40 bg-white/95 supports-[backdrop-filter]:bg-white/75 backdrop-blur/95 supports-[backdrop-filter]:bg-white/75 backdrop-blur border-b">
            <TableRow> {/* Replaced <tr> with <TableRow> */}
              ...
              <TableHead className="sticky top-[64px] z-40 bg-white/95 supports-[backdrop-filter]:bg-white/75 backdrop-blur px-4 py-3 text-right text-xs font-medium text-gray-600 uppercase tracking-wider">
              ...
              <TableHead className="sticky top-[64px] z-40 bg-white/95 supports-[backdrop-filter]:bg-white/75 backdrop-blur px-4 py-3 text-center text-xs font-medium text-gray-600 uppercase tracking-wider">
                {t('actions') || 'פעולות'}
              </TableHead>
            </TableRow>
          </TableHeader>
