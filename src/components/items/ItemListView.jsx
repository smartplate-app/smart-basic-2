    ...
    <div className="bg-white rounded-lg shadow">
      <div className="overflow-x-auto">
        <Table className="w-full"> {/* Replaced <table> with <Table> */}
          <TableHeader className="sticky top-14 md:top-24 z-30 bg-white/90 supports-[backdrop-filter]:bg-white/70 backdrop-blur border-b"> {/* Sticky header below filters */}
            <TableRow> {/* Replaced <tr> with <TableRow> */}
              <TableHead className="sticky top-14 md:top-24 z-40 bg-white/95 backdrop-blur px-3 py-3 text-center">
                <Checkbox checked={allSelected} onCheckedChange={() => onToggleSelectAll && onToggleSelectAll(items)} aria-label="Select all" />
              </TableHead>
              <TableHead className="sticky top-14 md:top-24 z-40 bg-white/95 backdrop-blur px-4 py-3 text-right text-xs font-medium text-gray-600 uppercase tracking-wider">
              ...
              <TableHead className="sticky top-14 md:top-24 z-40 bg-white/95 backdrop-blur px-4 py-3 text-center text-xs font-medium text-gray-600 uppercase tracking-wider">
                {t('actions') || 'פעולות'}
              </TableHead>
            </TableRow>
          </TableHeader>
