    ...
    <div className="bg-white rounded-lg shadow">
      <div className="overflow-x-auto relative">
        <div className="max-h-[70vh] overflow-y-auto">
          ...
          <TableHeader className="sticky top-0 z-40 bg-white/95 supports-[backdrop-filter]:bg-white/75 backdrop-blur/95 supports-[backdrop-filter]:bg-white/75 backdrop-blur border-b">
            <TableRow> {/* Replaced <tr> with <TableRow> */}
              <TableHead className="sticky top-0 z-40 bg-white/95 supports-[backdrop-filter]:bg-white/75 backdrop-blur px-3 py-3 text-center">
                <Checkbox checked={allSelected} onCheckedChange={() => onToggleSelectAll && onToggleSelectAll(items)} aria-label="Select all" />
              </TableHead>
              <TableHead className="sticky top-0 z-40 bg-white/95 supports-[backdrop-filter]:bg-white/75 backdrop-blur px-4 py-3 text-right text-xs font-medium text-gray-600 uppercase tracking-wider">
              ...
              <TableHead className="sticky top-0 z-40 bg-white/95 supports-[backdrop-filter]:bg-white/75 backdrop-blur px-4 py-3 text-center text-xs font-medium text-gray-600 uppercase tracking-wider">
                {t('actions') || 'פעולות'}
              </TableHead>
            </TableRow>
          </TableHeader>
