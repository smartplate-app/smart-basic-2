    ...
    <div className="bg-white rounded-lg shadow overflow-hidden">
      <div className="overflow-auto max-h-[70vh] sm:max-h-[75vh]">
        <Table className="w-full"> {/* Replaced <table> with <Table> */}
          <TableHeader className="sticky top-0 z-30 bg-white/90 supports-[backdrop-filter]:bg-white/70 backdrop-blur border-b"> {/* Sticky header below filters */}
            <TableRow> {/* Replaced <tr> with <TableRow> */}
              ...
              <TableHead className="sticky top-0 z-30 bg-white/95 backdrop-blur px-4 py-3 text-right text-xs font-medium text-gray-600 uppercase tracking-wider">
