    ...
    <div className="bg-white rounded-lg shadow relative min-h-0">
      <div className="relative overflow-visible">
        <Table className="w-full min-w-max"> {/* Replaced <table> with <Table> */}
          <TableHeader className="sticky top-[56px] md:top-[72px] z-50 bg-white supports-[backdrop-filter]:bg-white/80 backdrop-blur border-b shadow-sm"> {/* Sticky header below filters */}
            <TableRow> {/* Replaced <tr> with <TableRow> */}
              <TableHead className="sticky top-[56px] md:top-[72px] z-50 bg-white px-3 py-3 text-center bg-white">
              ...
              <TableHead className="sticky top-[56px] md:top-[72px] z-50 bg-white px-4 py-3 text-center text-xs font-medium text-gray-600 uppercase tracking-wider">
                {t('actions') || 'פעולות'}
              </TableHead>
            </TableRow>
          </TableHeader>
