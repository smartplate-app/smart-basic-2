...
Rules:
1. Extract Job Positions: name, section (kitchen/service/bar/management/cleaning/other), default_payment_type (hourly/monthly/daily), default_payment_amount.
2. Extract Workers: full_name, phone, job_position_name, payment_type (hourly/monthly/daily), payment_amount.
